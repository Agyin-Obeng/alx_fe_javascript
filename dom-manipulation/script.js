...
fetchServerQuotes();          // initial server sync
setInterval(fetchServerQuotes, 60000); // periodic server sync
syncBtn.addEventListener("click", fetchServerQuotes); // manual sync
